...
/* tagging */
static const char *tags[] = { "Terminal", "Books", "Messaging", "VMs", "5", "Music", "Brave", "8", "Firefox" };
...
static const char *i3lock[] = {"i3lock-color", "-c","000000", NULL};
